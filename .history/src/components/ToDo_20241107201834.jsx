    ...
    <div className="bg-[#f2f2f2] place-self-center w-11/12 max-w-md flex flex-col p-7 min-h-[550px] rounded-lg gap-4">
      ...
      <div className="flex items-center my-2 bg-gray-200 rounded-full">
        <input
          ...
          ref={inputRef}
        />
        <button className="border-none rounded-full bg-green-400 w-32 h-14 text-white text-lg font-medium cursor-pointer hover:bg-green-600">
          ADD +
        </button>
      </div>
      <div className="">
        <Item text="dskhflishfio" />
        <Item text="dskhflishfio" />
        <Item text="dskhflishfio" />
        <Item text="dskhflishfio" />
      </div>
